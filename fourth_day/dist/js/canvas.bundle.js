...
var _Object = /*#__PURE__*/function () {
  function Object(x, y, radius, color) {
    ...
    this.radius = radius;
    this.color = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomColor)(colors);
    this.mass = 1;
    this.opacity = 0;
  }
  _createClass(Object, [{
    ...
    value: function update(particles) {
      ...
      if ((0,_utils__WEBPACK_IMPORTED_MODULE_0__.distance)(mouse.x, mouse.y, this.x, this.y) < 80 && this.opacity < 0.2) {
        this.opacity += 0.02;
...
function init() {
  particles = [];
  // circle1 = new Object(300, 300, 150, "black");
  ...
  for (var i = 0; i < 200; i++) {
    ...
    particles.push(new _Object(x, y, radius, color));
  }
}
